...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two words which are combined to become this object's name.
     *
     * @param first the first half of the String name
     * @param last  the second half of the String name
     */
